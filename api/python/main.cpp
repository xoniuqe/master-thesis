...
double integrate_1d(Eigen::Ref<Eigen::Matrix<double, 3,2>> A1, Eigen::Ref<Eigen::Vector3d> b1, Eigen::Ref<Eigen::Vector3d>, Eigen::Ref<Eigen::Vector3d> mu1, double y, int k, double left_split, double right_split) {
