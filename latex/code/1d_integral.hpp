struct integral_1d {
		...
		integral_1d_test(const config::configuration& config, integrator::gsl_integrator* integrator, const std::vector<double> nodes, const std::vector<double> weights, const path_utils::path_function_generator path_function_generator, math_utils::green_fun_generator green_fun_generator);
