...
In dieser Arbeit wird das in \citetitle{gasperini:hal-03209144} \cite{gasperini:hal-03209144} vorgestellte Verfahren implementiert. Basierend auf der Matlab-Implementierung der Autoren wurde eine hinsichtlich der Benutzbarkeit und Laufzeit verbesserte C++-Implementierung umgesetzt.
...
In this paper, the method described in \citetitle{gasperini:hal-03209144} \cite{gasperini:hal-03209144}
